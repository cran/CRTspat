...
The potential for using the `CRTanalysis()` function to model the spillover and hence correct the naive efficacy estimate (from a t-test) can also be explored (see [Use Case 5](Usecase5.html)
and [Multerer *et al.* (2021b)](https://link.springer.com/article/10.1186/s12936-021-03924-7).
